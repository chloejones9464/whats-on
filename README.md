...
The ERD outlines the structure of the database used in this project. It shows the main models (`User`, `Event`, `Comment`, and `Profile`) and how they relate to one another.
...
- In the app’s **Settings**, under **Config Vars**, add: <br>
